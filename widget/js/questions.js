// Outdoorable Widget 2 - Questions Configuration
// Updated with flows.txt - Flow 1 and Flow 2
...
const questions = [
  ...
  },
  {
    ...
    example: "Portugal, Spain, or Argentina"
  },
  {
    id: "Q3",
    flow: "inspire",
  ...
  },
  {
    ...
    options: ["Mountains","Forest","Ocean / Coastline","Lake","Beach","Desert","Winter / Snow"]
  },
  {
    id: "Q4a",
    flow: "inspire",
    ...
    options: ["Big city","Small town / village","Rural countryside","Off the grid / remote","Open to a mix"]
  },
  {
    id: "Q4b",
    flow: "inspire",
    ...
    options: ["Single destination","Multi-destination","Roadtrip","Not sure yet — open to ideas"]
  },
  {
    id: "Q5",
    flow: "inspire",
    ...
    options: ["Luxe","Comfortable / Mid-range","Budget / Simple","Not sure yet"]
  },
  {
    id: "Q6",
    flow: "inspire",
    ...
    options: ["Winter (Dec–Feb)","Spring (Mar–May)","Summer (Jun–Aug)","Fall (Sep–Nov)","Not sure yet"]
  },
  {
    id: "Q7",
    flow: "inspire",
    ...
    options: ["Short trip: 2–4 days","1 week","2 weeks","3 weeks"]
  },
  {
    id: "Q7a",
    flow: "inspire",
    ...
    options: ["Camping / Rustic","Chain hotel or resort","Boutique / Guesthouse","Airbnb / Apartment rental","B&B / Farm stay","RV / Campervan","Not sure yet"]
  },
  {
    id: "Q7b",
    flow: "inspire",
    ...
    options: ["Trains","Rental car / self-drive","Public transit","Private transfers / guided transport","Not sure yet — open to suggestions"]
  },
  {
    id: "Q8",
    flow: "inspire",
    ...
    key: "party_type",
    text: "Who's going?",
    options: ["Friends","Couple","Solo","Family with young kids (under 12)","Family with kids 12–18","Multi-gen family","Work trip / Colleagues"]
  },
  {
    id: "Q8a",
    flow: "inspire",
    ...
    condition: { skipIf: { party_type: ["Couple", "Solo"] } }
  },
  {
    id: "Q8b",
    flow: "inspire",
    ...
    text: "Dynamic question depending on party_type", // Will be replaced in app.js
    example: "Most can hike 3–5 miles, one prefers scenic drives",
  ...
  },
  {
    ...
    options: ["70% Outdoors / 30% Culture","50% Outdoors / 50% Culture","30% Outdoors / 70% Culture"]
  },
  {
    id: "Q11",
    flow: "inspire",
    ...
    options: ["Hiking","Biking","Beaches & swimming","Surfing","Water activities","Skiing / Snowboarding","Scenic drives","Wildlife viewing","Family-friendly outdoor activities","Other…"]
  },
  {
    id: "Q12",
    flow: "inspire",
    ...
    options: ["Historic & archaeological sites","Art & museums","Live music / Nightlife","Markets","Spa / Wellness","Food experiences"]
  },
  {
    id: "Q13",
    flow: "inspire",
    ...
    options: ["Guided outdoor activities","Guided day trips","Guided city/cultural tours","Food/wine tours, cooking classes","No thanks — fully independent"]
  },
  {
    id: "Q14",
    flow: "inspire",
    ...
    options: ["Adventurous eats","Super local / traditional spots","Fine dining","Cooking classes","Food tours","Markets"]
  },
  {
    id: "Q15",
    flow: "inspire",
  ...
  },
  {
    ...
    example: "Relaxed with a few big active days"
  },

  // Flow 2 — Planning (FULL texts exactly as in spec, no emojis)
  ...
  // A) If Single destination
  {
    ...
    example: "Kyoto",
    condition: { equals: { key: "trip_structure", value: "🏠 Single destination (one home base, can include day trips)" } }
  },
  {
    id: "Q13A",
    flow: "planning",
    ...
    example: "Downtown ryokan, 4 nights",
    condition: { equals: { key: "trip_structure", value: "🏠 Single destination (one home base, can include day trips)" } }
  },
  {
    id: "Q14A",
  ...
  // B) If Multi-destination
  {
    ...
    example: "Florence 3 → Siena 2 → Rome 4",
    condition: { equals: { key: "trip_structure", value: "🧳 Multi‑destination (changing locations/lodging)" } }
  },
  {
    id: "Q13B",
    flow: "planning",
    ...
    options: ["Train / Public transport", "Rental car / Self-drive", "Mix", "Not sure yet"],
    condition: { equals: { key: "trip_structure", value: "🧳 Multi‑destination (changing locations/lodging)" } }
  },
  {
    id: "Q14B",
  ...
  },
  {
    ...
    options: ["Yes, up to 2 nights", "Maybe, 1 night", "No, keep it fixed"],
    condition: { equals: { key: "trip_structure", value: "🧳 Multi‑destination (changing locations/lodging)" } }
  },
  {
    id: "Q16B",
  ...
  },
  {
    ...
    example: "6 people, family reunion",
  ...
  // Q3b depends on party_type
  {
    ...
    example: "Happy with long hikes most days",
  ...
  },
  {
    ...
    example: "Most can do 5–7 mile hikes; one prefers easy walks",
  ...
  // Final two — full question texts (not labels)
  {
    ...
    example: "See northern lights, visit local markets"
  },
  {
    id: "Q11",
    flow: "planning",
    ...
    example: "No camping, avoid crowds"
  }
];
